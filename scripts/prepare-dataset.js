...
// import pe from '../data/support/peru-100k.json' assert { type: 'json' };
// import fetch from 'node-fetch'
const file = await fs.readFile(path.join(__dirname, '../data/input/peru-100k.json'), 'utf8');
const pe = JSON.parse(file);
...
// const response = await fetch('https://cdn.jsdelivr.net/npm/latam-atlas@0.0.4/files/peru-100k.json')
// const pe = await response.json()
console.log('pe: ', pathHist)
...
const outputFile = path.resolve(__dirname, '../data/output/output.csv')
